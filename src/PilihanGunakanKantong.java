...
public class PilihanGunakanKantong extends Pilihan {
    ...
    public void aksi() {
        ...
        if (barangPilih!=null) {
            ...
            if (barangPilih.id.equals("makanan")){
                oAdegan.oPlayer.kesehatan = oAdegan.oPlayer.kesehatan + 10;
            }else{
                oAdegan.oPlayer.kesehatan = oAdegan.oPlayer.kesehatan - 5;
            }

        }
        oAdegan.oPlayer.cekKesehatan();
    }
}
